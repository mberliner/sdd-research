...
4. **APLICADO (2026-07-28)** — **Registrar el patrón "gate fail-open"** como anti-patrón del marco de gobernanza: un *enforcement* cuya precondición opcional falta MUST fallar cerrado o declararse inoperante, nunca degradar a permisivo en silencio. **Materializado** en `../06-BACKLOG-INVESTIGACION-FUTURA.md` §Prioridad alta 4.
5. **APLICADO (2026-07-29)** — **Registrar el anti-patrón "variable de salida que es artefacto del propio tratamiento"** (confusión de visibilidad), derivado de la degradación de H2: cuando el tratamiento es una práctica documental y la variable de salida es ella misma un artefacto documental, el formato altera la **observabilidad** de su propio resultado. Corolario operativo: **`N/A` ≠ 0**. Test de diseño: ¿la variable de salida sobreviviría si el tratamiento no existiera? **Materializado** en `../06-BACKLOG-INVESTIGACION-FUTURA.md` §Prioridad alta 6.
...
| `06-BACKLOG-INVESTIGACION-FUTURA.md` | 5 ítems en prioridad alta | +6: anti-patrón de confusión de visibilidad | **sincronizado** (2026-07-29) |
...
- Derivados a revisar: EXPERIMENTO-B7-formato-hibrido.md (checklist + criterio de éxito), ../software/PLAN-PRUEBAS.md §B-07, ../06-BACKLOG-INVESTIGACION-FUTURA.md #4
