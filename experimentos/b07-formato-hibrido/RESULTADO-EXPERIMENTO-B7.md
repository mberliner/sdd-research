...
- **Check 3** (`grep -rl "Deuda arrastrada.*B-07"`): `software/COMPARATIVA-SPECKIT-VS-TESTIGO.md`, `software/ANALISIS-SPEC-KIT.md`, `software/DECISION-ADOPTAR-VS-PORTAR-SPECKIT.md`, `experimentos/b07-formato-hibrido/PREREG-B7.md`.
