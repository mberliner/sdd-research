...
**Herramienta de terceros: el sello es del día de la corrida, no del diseño.** Cuando un componente es una herramienta que se actualiza sola, su versión MUST NOT fijarse al escribir el diseño: una versión elegida con antelación llega desactualizada —o no instalable— al momento de correr, y hay herramientas que publican varias versiones en un mismo día. Se sella la versión **efectiva al abrir cada tanda** y se la vuelve a leer en cada rep. Eso deja el componente en escalón 2 dentro de la tanda —se detecta el cambio, no se impide— y en escalón 3 entre tandas: una diferencia entre tandas es legítima, MUST registrarse y MUST declararse junto al resultado como confundido conocido y no removido. Llegar al escalón 1 exige suprimir la actualización mientras dura la tanda, lo que MAY no ser posible y MUST NOT suponerse.
