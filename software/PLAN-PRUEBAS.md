...
- Hipotesis: ver B6 en `LINEAS-INVESTIGACION.md` (specs vivas como circuito de aprendizaje vs. cascada encubierta, `../SDD-ADAPTATIVO-VS-CASCADA.md`).
...
| B7 (formato hibrido Spec Kit) | B-07 | cerrado (`../experimentos/RESULTADO-EXPERIMENTO-B7.md`) — su componente de regenerabilidad (H4) **no queda sostenida, sin ser refutada** |
