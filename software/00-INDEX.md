...
- [CONVERGENCIA-IMPLEMENTACIONES-SDD.md](./CONVERGENCIA-IMPLEMENTACIONES-SDD.md) — SSOT: qué elementos del método SDD son invariantes entre implementaciones independientes y cuáles no, leído sobre tres casos con un instrumento común.
