...
- Derivados a revisar: ninguno registrado para este documento. Señalado sin modificar: `software/analisis/ANALISIS-SPEC-KIT.md` §Actualizacion 2026-09-05 dejo esta actualizacion como deuda y **queda saldada acá**
...
- Riesgos/reservas: el bloque anterior de este documento sigue diciendo «SSOT afectado: ninguno (derivado de `software/analisis/ANALISIS-SPEC-KIT.md`)» y NO se corrige: es registro datado y la corrección se anota hacia adelante, no hacia atrás
