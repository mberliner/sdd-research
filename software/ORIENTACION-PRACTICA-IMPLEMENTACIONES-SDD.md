...
| Tessl [R46] | **No** toma columna | **No, todavía** | Su *Framework* está en **beta cerrada**: no se puede adoptar hoy. El criterio de esta población es la adoptabilidad, y no la cumple. Su *Spec Registry* sí está en beta abierta, pero es un catálogo de specs de librerías, no un método que se instale. Caracterización en `ANALISIS-TESSL.md`; **revisar si el Framework abre** |
